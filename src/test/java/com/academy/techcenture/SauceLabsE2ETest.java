...
public class SauceLabsE2ETest {
    ...
    public void sauceLabsE2ETest() throws InterruptedException {
        ...
        if(closeMenu.isDisplayed()){
            ...
            System.out.println("close menu was already closed");
        }
        ...
        Assert.assertTrue(firstPrice && lastPrice, "First and last price are not correct");
        ...
        Assert.assertTrue(onesieDescription.getText().equals("Rib snap infant onesie for the junior automation engineer in development." +
                " Reinforced 3-snap bottom closure, two-needle hemmed sleeved and bottom won't unravel."), "Product discription did not match" );
        ...
        Assert.assertTrue(clickBtn.isDisplayed(), "Add to cart Btn is NOT displayed");
        ...
        Assert.assertTrue(driver.findElement(By.className("title")).isDisplayed(), "Filter component was not displayed");
        ...
        Assert.assertTrue(driver.findElement(By.className("title")).isDisplayed(), "Check out header eas not displayed");
        ...
        Assert.assertTrue(deliveryInfo.getText().equals("FREE PONY EXPRESS DELIVERY!"), "Delivery info did NOT match");
        ...
        Assert.assertTrue(driver.findElement(By.id("finish")).isEnabled(), "finish Btn was NOT enabled");
        ...
        Assert.assertTrue(img , "Image was NOT displayed");

        Assert.assertTrue(driver.findElement(By.id("back-to-products")).isEnabled(), "Back to products was not enabled");
